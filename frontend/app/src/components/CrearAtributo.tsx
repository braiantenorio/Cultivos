...
function CrearAtributo() {
	...
	function handleLimiteCaracteresChange(e: React.ChangeEvent<HTMLInputElement>) {
		setAtributo({
			...atributo,
		...
		<div className='container'>
			...
			<form className="row g-3" onSubmit={handleSubmit} >
				<div className="col-md-4">
					...
					<input type="text" className="form-control" id="validationCustom01" value={atributo.nombre} onChange={handleNombreChange} required />
				</div>
				...
				<div className="col-md-2">
					<label htmlFor="validationCustomUsername" className="form-label">Rango minimo</label>
					<input type="number" className="form-control" id="validationCustomUsername" value={atributo.minimo} onChange={handleRangoMinimoChange}
					/>
				</div>
				<div className="col-md-2">
					<label htmlFor="validationCustom02" className="form-label">Limite de carateres</label>
					<input type="number" className="form-control" id="validationCustom02" value={atributo.caracteres} onChange={handleLimiteCaracteresChange} />
				</div>
				<div className="col-md-2">
					<label htmlFor="validationCustom03" className="form-label">Rango maximo</label>
					<input type="number" className="form-control" id="validationCustom03" value={atributo.maximo} onChange={handleRangoMaximoChange} />
				</div>
				<div className="col-md-2">
					<label htmlFor="validationCustom05" className="form-label">Limite de decimales</label>
					<input type="number" className="form-control" id="validationCustom05" value={atributo.decimales} onChange={handleLimiteDecimalesChange} />
				</div>
